"""Standalone script: run build_histogram_model.py's run_one_case() across
many config files in parallel, e.g. one config per forecast/init-time.

Run with:
  /opt/anaconda3/envs/pysteps_env/bin/python python_obj/drivers/build_histogram_model_batch.py
