"""Standalone script: run fetch_mrms.py's run_one_case() across many config
files in parallel, e.g. one config per model directory/case.

Run with:
  /opt/anaconda3/envs/pysteps_env/bin/python python_obj/drivers/fetch_mrms_batch.py
...
from python_obj.drivers.fetch_mrms import run_one_case
