"""Standalone script: run interpolate_mrms.py's run_one_case() across many
config files in parallel, e.g. one config per case/day.

Run with:
  /opt/anaconda3/envs/pysteps_env/bin/python python_obj/drivers/interpolate_mrms_batch.py
...
from python_obj.drivers.interpolate_mrms import run_one_case
