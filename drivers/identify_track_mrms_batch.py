"""Standalone script: run identify_track_mrms.py's run_one_case() across
many config files in parallel, e.g. one config per case/day.

Run with:
  /opt/anaconda3/envs/pysteps_env/bin/python python_obj/drivers/identify_track_mrms_batch.py
